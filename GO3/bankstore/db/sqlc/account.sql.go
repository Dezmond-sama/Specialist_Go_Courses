...
func (q *Queries) UpdateAccountOwner(ctx context.Context, arg UpdateAccountOwnerParams) (Accounts, error) {
	row := q.db.QueryRow(ctx, updateAccountOwner, arg.ID, arg.Owner)
	var i Accounts
	err := row.Scan(
		&i.ID,
		&i.Owner,
